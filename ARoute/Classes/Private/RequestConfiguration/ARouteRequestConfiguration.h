...
@property (strong, nonatomic, nullable) UIViewController * _Nullable (^embeddingViewControllerBlock)(void);
...
@property (strong, nonatomic, nullable) BOOL (^animatedBlock)(void);
...
@property (strong, nonatomic, nullable) id <UIViewControllerTransitioningDelegate> _Nullable(^transitioningDelegateBlock)(void);
@property (strong, nonatomic, nullable) id <UINavigationControllerDelegate> _Nullable(^navigationViewControllerDelegateBlock)(void);
