...
- (void)setAroute_navigationControllerDelegate:(id<UIViewControllerTransitioningDelegate>)aroute_navigationControllerDelegate
{
...
- (id<UIViewControllerTransitioningDelegate>)aroute_navigationControllerDelegate
{
